...
urlpatterns = [
    ...
    path(
        'thangka-paintings-list/',
        views.thangka_paintings_view,
        name='thangka_paintings_list'
    ),
    path(
    ...
    path(
        'gods-goddesses-list/',
        views.gods_goddesses_view,
        name='gods_goddesses_list'
    ),
    path(
        'singing-bowls-list/',
        views.singing_bowls_view,
        name='singing_bowls_list'
    ),
